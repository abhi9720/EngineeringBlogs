...
description: >-
  Master Feign clients for microservice communication: declarative REST clients,
  Spring Cloud OpenFeign configuration, custom decoders, error handling, load
  balancing, and resilience patterns
date: '2026-05-11'
