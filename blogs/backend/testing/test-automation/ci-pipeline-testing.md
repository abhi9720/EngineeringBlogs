...
```
        ...
        ╰──────────╯
       ╱────────────╲
      ╱ Integration  ╲     Some: Service interactions, database
     ╰────────────────╯
    ╱──────────────────╲
...
```
Time: 0s         5s         15s        30s       60s
      ├───────────┬───────────┬──────────┬──────────┤
      │ Unit      │ Component │ Integr.  │ Contract  │
      │ Tests     │ Tests     │ ation    │ Tests     │
      │ (fast)    │ (medium)  │ Tests    │           │
      │           │           │ (slower) │           │
      └───────────┴───────────┴──────────┴──────────┘
                │           │          │
                ▼           ▼          ▼
           Fast feedback   Gate      Background
```
